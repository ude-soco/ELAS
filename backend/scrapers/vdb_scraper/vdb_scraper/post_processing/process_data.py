...
VDB_DATA_DIRECTORY = os.path.abspath(os.path.join(backend_directory, "scrapers", "vdb_scraper", "description_results.json"))
VDB_DESTINATION_DIRECTORY = os.path.abspath(os.path.join(backend_directory, "scrapers", "vdb_scraper", "vdb_scraper", "Data", "post_processed_descriptions.json"))
